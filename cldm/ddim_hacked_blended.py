...
class DDIMSampler(object):
    ...
    def ddim_sampling(
        ...
        if init_image is not None:
            assert x0 is None and x_T is None, "Try to infer x0 and x_t from init_image, but they already provided"
        ...
        for i, step in enumerate(time_range):
            ...
            if org_mask is not None and i >= cutoff_point:
                ...
                img_x0 = self.model.get_first_stage_encoding(self.model.encode_first_stage(pixel_blended))
